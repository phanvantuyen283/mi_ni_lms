...
const EXAM_STRUCTURE = [
  ...
  },
  {
    ...
    rubric: "- Giải thích được từ 'thanh lịch' gắn với vẻ đẹp con người và đất nước (1.5đ)\n- Nêu được mối quan hệ giữa con người và thiên nhiên (núi rừng cũng trở nên có hồn, nên thơ) (1.5đ)\n- Thể hiện được niềm tự hào, tình yêu quê hương đất nước sâu sắc của tác giả (2đ).",
    max_score: 5
  },
  {
    id: "t4",
